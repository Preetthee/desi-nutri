...
export const bn = {
  ...
  'analytics.description': 'আপনার ক্যালোরি এবং স্বাস্থ্য মেট্রিক্সের বিস্তারিত দেখুন।',
  'analytics.view.daily': 'দৈনিক',
  'analytics.view.weekly': 'সাপ্তাহিক',
  'analytics.view.monthly': 'মাসিক',
  'analytics.calories_chart_title': 'দৈনিক ক্যালোরি গ্রহণ (গড়)',
  'analytics.steps_chart_title': 'দৈনিক পদক্ষেপ (গড়)',
  'analytics.sleep_chart_title': 'দৈনিক ঘুম (গড়)',
  'analytics.water_chart_title': 'দৈনিক জল গ্রহণ (গড়)',
  'analytics.workout_chart_title': 'দৈনিক ওয়ার্কআউট (গড়)',
